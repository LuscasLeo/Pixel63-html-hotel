...
import WiredActionGiveScoreTeamLogic from "./Logic/Wired/Action/WiredActionGiveScoreTeamLogic";
...
import WiredActionGiveHanditemLogic from "./Logic/Wired/Action/WiredActionGiveHanditemLogic";
import WiredActionBotMoveToFurniLogic from "./Logic/Wired/Action/WiredActionBotMoveToFurniLogic";
import WiredActionBotTeleportToFurniLogic from "./Logic/Wired/Action/WiredActionBotTeleportToFurniLogic";
...
export default class RoomFurnitureLogicFactory {
    public static getLogic(roomFurniture: RoomFurniture): RoomFurnitureLogic | null {
        switch(roomFurniture.model.furniture.interactionType) {
            ...
            case "wf_act_flee":
                return new WiredActionFleeLogic(roomFurniture);

            case "wf_act_join_team":
                return new WiredActionJoinTeamLogic(roomFurniture);
            ...
            case "wf_act_give_score_team":
                return new WiredActionGiveScoreTeamLogic(roomFurniture);

            case "wf_act_freeze":
                return new WiredActionFreezeLogic(roomFurniture);

            case "wf_act_unfreeze":
                return new WiredActionUnfreezeLogic(roomFurniture);
            ...
            case "wf_act_bot_give_handitem":
                return new WiredActionGiveHanditemLogic(roomFurniture);

            case "wf_act_bot_move":
                return new WiredActionBotMoveToFurniLogic(roomFurniture);

            case "wf_act_bot_teleport":
                return new WiredActionBotTeleportToFurniLogic(roomFurniture);

            case "wf_act_bot_talk":
                return new WiredActionBotTalkLogic(roomFurniture);

            case "wf_act_bot_talk_to_avatar":
                return new WiredActionBotTalkToUserLogic(roomFurniture);
