...
import { BurnRoomFurnitureTraxSongData, CreateRoomData, DeleteRoomFurnitureTraxSongData, DeleteRoomMapData, DeleteShopFurnitureData, DeleteShopMembershipData, EnterRoomBellQueueData, EnterRoomData, ExitRoomBellQueueData, GetAchievementsCategoriesData, GetAchievementsData, GetBadgeBrowserData, GetFurnitureBrowserData, GetFurnitureCrackableData, GetFurnitureTypesData, GetGroupData, GetGroupMembersData, GetHotelFeedbackData, GetHotelSettingsData, GetNavigatorData, GetPetBreedsData, GetPetBrowserData, GetRoomCategoriesData, GetRoomChatStylesData, GetRoomMapsData, GetRoomWiredLogsData, GetRoomWiredMonitorData, GetShopFurnitureLinkData, GetShopPageBotsData, GetShopPageBundleFurnitureData, GetShopPageFurnitureData, GetShopPageLinkData, GetShopPageMembershipsData, GetShopPagePetsData, GetShopPagesData, GetUserBadgesData, GetUserBotSpeechData, GetUserClothesData, GetUserData, GetUserEffectsData, GetUserFiguresData, GetUserFriendRelationshipsData, GetUserFriendsData, GetUserGroupData, GetUserInventoryBadgesData, GetUserInventoryBotsData, GetUserInventoryFurnitureData, GetUserInventoryPetsData, GetUserInventorySongDisksData, GetUserInventorySoundSetsData, GetUserProfileData, GetUserRoomsData, HotelAlertData, InsertRoomFurnitureTraxSongData, LeaveRoomData, MessageType, PickupAllRoomFurnitureData, PickupRoomBotData, PickupRoomFurnitureData, PickupRoomPetData, PingData, PlaceRoomBotData, PlaceRoomContentFurnitureData, PlaceRoomFurnitureData, PlaceRoomPetData, PurchaseRoomCameraPhotoData, PurchaseShopBotData, PurchaseShopBundleData, PurchaseShopFurnitureData, PurchaseShopMembershipData, PurchaseShopPetData, RemoveUserFriendData, RequestRoomUserTradingData, ResetRoomClickConfigurationData, RoomClickData, RoomDoubleClickData, RoomFurnitureImportData, RoomReadyData, SearchUserFriendsData, SendHotelFeedbackData, SendRoomChatMessageData, SendRoomUserWalkData, SendUserFriendMessageData, SendUserFriendRequestData, SetRoomChatTypingData, SetRoomClickConfigurationData, SetRoomUserRightsData, SetUserFigureConfigurationData, SetUserHomeRoomData, SetUserMottoData, SetUserRoomChatStyleData, UpdateBadgeData, UpdateClothingData, UpdateFurnitureCrackableData, UpdateFurnitureData, UpdateGroupData, UpdateHotelSettingData, UpdatePetData, UpdateRoomBellQueueData, UpdateRoomBotData, UpdateRoomFurnitureData, UpdateRoomFurnitureTraxPlaylistData, UpdateRoomFurnitureTraxSongData, UpdateRoomInformationData, UpdateRoomMapData, UpdateRoomStructureData, UpdateRoomUserTradingData, UpdateShopBotData, UpdateShopFeatureData, UpdateShopFurnitureData, UpdateShopMembershipData, UpdateShopPageData, UpdateShopPetData, UpdateUserBadgeData, UpdateUserFriendRelationshipData, UpdateUserFriendRequestData, UserFigureData, UseRoomFurnitureData } from "@pixel63/events";
...
import SetRoomClickConfigurationEvent from "../Communication/Game/Rooms/Configuration/SetRoomClickConfigurationEvent.js";
import ResetRoomClickConfigurationEvent from "../Communication/Game/Rooms/Configuration/ResetRoomClickConfigurationEvent.js";
import PickupAllRoomFurnitureEvent from "../Communication/Game/Rooms/Furniture/PickupAllRoomFurnitureEvent.js";
import PurchaseRoomCameraPhotoEvent from "../Communication/Game/Rooms/Camera/PurchaseRoomCameraPhotoEvent.js";
import GetShopPageLinkEvent from "../Communication/Game/Shop/GetShopPageLinkEvent.js";
import GetShopPageMembershipsEvent from "../Communication/Game/Shop/GetShopPageMembershipsEvent.js";
import UpdateShopMembershipEvent from "../Communication/Game/Shop/Development/UpdateShopMembershipEvent.js";
import DeleteShopMembershipEvent from "../Communication/Game/Shop/Development/DeleteShopMembershipEvent.js";
import PurchaseShopMembershipEvent from "../Communication/Game/Shop/PurchaseShopMembershipEvent.js";
import UpdateRoomMapEvent from "../Communication/Game/Rooms/Maps/UpdateRoomMapEvent.js";
import DeleteRoomMapEvent from "../Communication/Game/Rooms/Maps/DeleteRoomMapEvent.js";
import RequestRoomUserTradingEvent from "../Communication/Game/Rooms/User/Trading/RequestRoomUserTradingEvent.js";
import UpdateRoomUserTradingEvent from "../Communication/Game/Rooms/User/Trading/UpdateRoomUserTradingEvent.js";
import GetHotelSettingsEvent from "../Communication/Game/Hotel/Settings/GetHotelSettingsEvent.js";
import UpdateHotelSettingEvent from "../Communication/Game/Hotel/Settings/UpdateHotelSettingEvent.js";
import GetRoomWiredMonitorEvent from "../Communication/Game/Rooms/Wired/GetRoomWiredMonitorEvent.js";
import GetRoomWiredLogsEvent from "../Communication/Game/Rooms/Wired/GetRoomWiredLogsEvent.js";
import UpdateUserFriendRelationshipEvent from "../Communication/Game/Users/Friends/UpdateUserFriendRelationshipEvent.js";
import GetUserFriendRelationshipsEvent from "../Communication/Game/Users/Friends/GetUserFriendRelationshipsEvent.js";
import GetUserRoomsEvent from "../Communication/Game/Users/Rooms/GetUserRoomsEvent.js";
import GetGroupEvent from "../Communication/Game/Groups/GetGroupEvent.js";
import GetUserGroupEvent from "../Communication/Game/Groups/GetUserGroupEvent.js";
import GetGroupMembersEvent from "../Communication/Game/Groups/GetGroupMembersEvent.js";
import UpdateGroupEvent from "../Communication/Game/Groups/UpdateGroupEvent.js";
