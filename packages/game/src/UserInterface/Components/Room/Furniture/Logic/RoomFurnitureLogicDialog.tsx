...
import WiredActionLeaveTeamDialog from "@UserInterface/Components/Room/Furniture/Logic/Wired/Action/WiredActionLeaveTeamDialog";
import WiredActionGiveScoreDialog from "@UserInterface/Components/Room/Furniture/Logic/Wired/Action/WiredActionGiveScoreDialog";
import WiredActionGiveScoreTeamDialog from "@UserInterface/Components/Room/Furniture/Logic/Wired/Action/WiredActionGiveScoreTeamDialog";
...
import WiredActionBotTeleportToFurniDialog from "@UserInterface/Components/Room/Furniture/Logic/Wired/Action/WiredActionBotTeleportToFurniDialog";
...
export default function RoomFurnitureLogicDialog(props: RoomFurnitureLogicDialogProps) {
    switch(props.data.furnitureData.interactionType) {
        ...
        case "wf_act_call_stacks":
            return (<WiredActionCallStacksDialog {...props}/>);
        ...
        case "wf_act_set_altitude":
            return (<WiredActionSetAltitudeDialog {...props}/>);
        ...
        case "wf_act_leave_team":
            return (<WiredActionLeaveTeamDialog {...props}/>);

        case "wf_act_give_score":
            return (<WiredActionGiveScoreDialog {...props}/>);

        case "wf_act_give_score_team":
            return (<WiredActionGiveScoreTeamDialog {...props}/>);

        case "wf_act_freeze":
            return (<WiredActionFreezeDialog {...props}/>);

        case "wf_act_unfreeze":
            return (<WiredCommonDelayDialog {...props}/>);
        ...
        case "wf_act_bot_teleport":
            return (<WiredActionBotTeleportToFurniDialog {...props}/>);

        case "wf_act_bot_talk":
            return (<WiredActionBotTalkDialog {...props}/>);

        case "wf_act_bot_talk_to_avatar":
            return (<WiredActionBotTalkToUserDialog {...props}/>);
